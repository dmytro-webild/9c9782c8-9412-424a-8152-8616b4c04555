      ...
      features={[
        {
          ...
          description: "We provide rapid response times for all your urgent HVAC needs.",
        },
        {
          icon: ShieldCheck,
          title: "Licensed & Insured",
          description: "Rest easy knowing your property is in professional, capable hands.",
        },
        {
          icon: DollarSign,
        ...
        },
        {
          ...
          description: "Expert solutions to save you money and keep your home comfortable.",
        },
        {
          icon: Star,
          title: "5-Star Experience",
          description: "Consistently professional service backed by customer satisfaction.",
        },
      ]}
  ...
  <div id="services" data-section="services">
      ...
      products={[
        ...
        },
        {
          id: "3",
          name: "Duct Cleaning",
          price: "Breathe Better",
          variant: "Air Quality",
          imageSrc: "http://img.b2bpic.net/free-photo/thoughtful-man-holding-tablet-standing-looking-away-cropped-side-view-caucasian-courier-red-uniform-looking-required-address-selective-focus-delivery-service-post-concept_74855-12024.jpg",
        },
        {
          id: "4",
        ...
        },
        {
          ...
          price: "Customized",
          variant: "Air Quality",
          imageSrc: "http://img.b2bpic.net/free-photo/vertical-shot-young-asian-woman-cooking-dinner-making-herself-sandwitch-smiling-while-standing_1258-191643.jpg",
        },
      ]}
      ...
      buttons={[
        {
          ...
          href: "mailto:corey.etris@hotmail.com",
        },
      ]}
    />
  </div>
